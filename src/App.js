...
dark:text-gray-300"
              >
                01{" "}
                <span className="text-xs text-center mb-2 sm:text-sm flex-row flex-1 ml-1 mt-6 sm:mr-12 text-gray-700 dark:text-gray-300 ">
                  Day
                </span>
              </h1>
            </div>
...
dark:text-gray-300"
              >
                00{" "}
                <span className="text-xs text-center mb-2 sm:text-sm flex-row  flex-1  mt-6 sm:mr-10 text-gray-700 dark:text-gray-300">
                  Minute
                </span>
              </h1>
            </div>
...
dark:text-gray-300"
          ...
          <div className="flex mt-9 md:mt-8 justify-between w-full space-x-2">
            <div className="shadow-lg h-16  flex-1 sm:mr-2 rounded-3xl dark:bg-black   relative flex-row sm:h-20 ">
              ...
              <h2
                className="text-sm mt-8 dark:text-gray-300
dark:text-gray-300 ml-4 md:text-lg font-bold text-center md:mt-10 "
              >
                LDX = 0.1 BUSD
              </h2>
            </div>
            <div className="shadow-lg flex-1  rounded-3xl dark:bg-black  relative flex-row md:h-20 ">
              ...
              <h2
                className="text-sm mt-8 dark:text-gray-300
dark:text-gray-300 md:text-lg font-bold text-center md:mt-10"
              >
                6,253,800.679 LDX
              </h2>
            </div>
          ...
          {/* ICO Progress */}
          <div className="w-full  mt-2 h-32 p-4  shadow-lg rounded-3xl dark:bg-black  ">

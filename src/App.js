      ...
      <div className="mb-8  flex-1 flex-col sm:ml-3 sm:flex-row  ">
        ...
        <div className="flex justify-between space-x-0.5 sm:space-x-6 max-w-xs sm:w-full ">
          <div className="rounded-3xl  sm:h-20 flex-1 flex-row  shadow-lg ">
            <h1 className="text-2xl mt-2 sm:text-5xl flex items-end ml-4 sm:mt-6 text-center font-normal text-black">
              01{" "}
          ...
          <div className="rounded-3xl  sm:h-20 flex-1 flex-row  shadow-lg ">
            <h1 className="text-2xl mt-2 sm:text-5xl flex items-end ml-2 sm:mt-6 text-center font-normal text-black">
              01{" "}
              <span className="text-xs text-center mb-2 sm:text-sm flex-row  flex-1 ml-1 mt-6 sm:mr-12 text-gray-700">
                Hours
              </span>
